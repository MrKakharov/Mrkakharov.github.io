...
<details>
      <summary>▶️ Documentation - P2P - Evaluation</summary>
      <details>
            <summary>Documentation - P2P - Evaluation - 01 - Before (as evaluated student)</summary>
            {% include embed/youtube.html id='CF0lx9o1RCE' %}
      </details>
      <details>
            <summary>Documentation - P2P - Evaluation - 02 - Before (as evaluator)</summary>
            {% include embed/youtube.html id='eTt5NQUO3LY' %}
      </details>
      <details>
            <summary>Documentation - P2P - Evaluation - 03 - During the evaluation</summary>
            {% include embed/youtube.html id='_GgfLzcgNvQ' %}
      </details>
      <details>
            <summary>Documentation - P2P - Evaluation - 04 - After (as evaluated student)</summary>
            {% include embed/youtube.html id='hzMe_CDM8ug' %}
      </details>
</details>
...
<details>
      <summary>▶️ Shell - I Basics - 01 - 10</summary>
      <details>
            <summary>Shell - I Basics - 1 Introduction</summary>
            {% include embed/youtube.html id='rd5wjtD3aQA' %}
      </details>
      <details>
            <summary>Shell - I Basics - 2 cd et file system</summary>
            {% include embed/youtube.html id='MmNQ2SQiUO0' %}
      </details>
      <details>
            <summary>Shell - I Basics - 3 chmod</summary>
            {% include embed/youtube.html id='60K0zFw92xM' %}
      </details>
      <details>
            <summary>Shell - I Basics - 4 echo, cat, ls et touch</summary>
            {% include embed/youtube.html id='DMfpAHkaAa8' %}
      </details>
      <details>
            <summary>Shell - I Basics - 5 $, env et export</summary>
            {% include embed/youtube.html id='GyHOgbtqPv8' %}
      </details>
      <details>
            <summary>Shell - I Basics - 6 wildcard, tilde et guillemets</summary>
            {% include embed/youtube.html id='OMzfnhmXmNE' %}
      </details>
      <details>
            <summary>Shell - I Basics - 7 more, tail, head et grep</summary>
            {% include embed/youtube.html id='Y-Yk2YGrE9U' %}
      </details>
      <details>
            <summary>Shell - I Basics - 8 stdout, stderr et stdin</summary>
            {% include embed/youtube.html id='TplIKwhKXDI' %}
      </details>
      <details>
            <summary>Shell - I Basics - 9 find, wc et bc</summary>
            {% include embed/youtube.html id='pjIysRXs1C8' %}
      </details>
      <details>
            <summary>Shell - I Basics - 10 shellctrl, ctrl c et ctrl</summary>
            {% include embed/youtube.html id='9Ae8Vsgv8Hw' %}
      </details>
</details>
...
<details>
      <summary>📕 shell00.pdf faylini o'qish</summary>
      {% include embed/pdf.html url="https://raw.githubusercontent.com/MrKakharov/YAKUNLANGAN_BASSEYN_PISCINE_C/master/shell00/shell00.pdf" %}
</details>
...
<details>
      <summary>📕 shell01.pdf faylini o'qish</summary>
